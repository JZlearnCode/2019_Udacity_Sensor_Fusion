...
The results of completing the UKF code can be seen in the animation, where each of the three traffic cars are tracked using a CTRV motion model. 

<img src="media/15_ukf_highway_tracked.gif" width="700" height="400" />
