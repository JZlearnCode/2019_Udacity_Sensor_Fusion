...
UKF::UKF() {
  ...
  /*
  * initialization of other variables defined in ukf.h
  */
  n_x_ = 5;
  n_aug_ = 7;
  n_sig_ = 2 * n_aug_ + 1;
...
// /**
//  * Based on example from Udacity course material 
//  */
...
//   // Xsig_out   (n_x, 2 * n_x + 1)
//   for (int i = 0; i < n_x_; ++i) {
//     Xsig_out->col(i+1)     = x_ + sqrt(lambda_+n_x_) * sqrt_P.col(i);
//     Xsig_out->col(i+1+n_x_) = x_ - sqrt(lambda_+n_x_) * sqrt_P.col(i);
//   }
// }
...
void UKF::AugmentedSigmaPoints(MatrixXd* Xsig_aug) {
  ...
  // create augmented sigma points  (n_aug_, 2 * n_aug_ + 1)
